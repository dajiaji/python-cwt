...
class TestRSAKey:
    ...
    def test_rsa_key_constructor_with_private_key(self, private_key, public_key):
        assert private_key.kty == COSEKeyTypes.RSA
        assert private_key.kid is None
        assert private_key.alg == COSEAlgs.RS256
        ...
        assert public_key.kty == COSEKeyTypes.RSA
        assert public_key.kid is None
        assert public_key.alg == COSEAlgs.RS256
        ...
        assert private_key_obj[COSEKeyParams.KTY] == COSEKeyTypes.RSA
        public_key_obj = public_key.to_dict()
        assert public_key_obj[COSEKeyParams.KTY] == COSEKeyTypes.RSA
        try:
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            (
                {COSEKeyParams.KTY: COSEKeyTypes.RSA, COSEKeyParams.ALG: "xxx"},
                "Unsupported or unknown alg(3): xxx.",
            ),
            (
                {COSEKeyParams.KTY: COSEKeyTypes.RSA, COSEKeyParams.ALG: 0},
                "Unsupported or unknown alg(3) for RSA: 0.",
            ),
            (
                {COSEKeyParams.KTY: COSEKeyTypes.RSA, COSEKeyParams.ALG: -65535},
            ...
            (
                {
                    COSEKeyParams.KTY: COSEKeyTypes.RSA,
                    COSEKeyParams.ALG: COSEAlgs.RS256,
                    COSEKeyParams.KEY_OPS: [COSEKeyOps.ENCRYPT],
                },
            ...
            (
                {
                    COSEKeyParams.KTY: COSEKeyTypes.RSA,
                    COSEKeyParams.ALG: COSEAlgs.RS256,
                    COSEKeyParams.KEY_OPS: [COSEKeyOps.VERIFY],
                },
            ...
            (
                {
                    ...
                    COSEKeyParams.KEY_OPS: [COSEKeyOps.VERIFY],
                    COSEKeyParams.RSA_N: b"xxx",
                    COSEKeyParams.RSA_E: b"xxx",
                    COSEKeyParams.RSA_P: b"xxx",
                },
