...
class TestCOSEKey:
    ...
    def test_key_builder_from_symmetric_key_hmac(self, alg, alg_label):
        ...
        assert COSEKeyOps.MAC_CREATE in k.key_ops
        assert COSEKeyOps.MAC_VERIFY in k.key_ops
    ...
    def test_key_builder_from_symmetric_key_without_key(self, alg):
        try:
            ...
            assert k.kty == COSEKeyTypes.ASYMMETRIC
        except Exception:
    ...
    @pytest.mark.parametrize(
        "key_ops, expected",
        [
            ([COSEKeyOps.VERIFY], [COSEKeyOps.VERIFY]),
            (["verify"], [COSEKeyOps.VERIFY]),
        ],
    )
    ...
    @pytest.mark.parametrize(
        "key_ops, expected",
        [
            ([COSEKeyOps.SIGN, COSEKeyOps.VERIFY], [COSEKeyOps.SIGN, COSEKeyOps.VERIFY]),
            (["sign", "verify"], [COSEKeyOps.SIGN, COSEKeyOps.VERIFY]),
            (["verify"], [COSEKeyOps.VERIFY]),
            (["sign"], [COSEKeyOps.SIGN]),
        ],
    )
    ...
    @pytest.mark.parametrize(
        "invalid, msg",
        [
            ([COSEKeyOps.SIGN], "Invalid key_ops for Ed25519/448 public key."),
    ...
    @pytest.mark.parametrize(
        "invalid, msg",
        [
            ([COSEKeyOps.MAC_CREATE], "Unknown or not permissible key_ops(4) for OKP."),
            (
                ["MAC create"],
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            {COSEKeyParams.KTY: COSEKeyTypes.ASYMMETRIC, COSEKeyParams.ALG: COSEAlgs.HS256_64},
            {COSEKeyParams.KTY: COSEKeyTypes.ASYMMETRIC, COSEKeyParams.ALG: COSEAlgs.HS256},
            {COSEKeyParams.KTY: COSEKeyTypes.ASYMMETRIC, COSEKeyParams.ALG: COSEAlgs.HS384},
            {COSEKeyParams.KTY: COSEKeyTypes.ASYMMETRIC, COSEKeyParams.ALG: COSEAlgs.HS512},
    ...
    @pytest.mark.parametrize(
        ...
        [
            ({}, "kty(1) not found."),
            ({COSEKeyParams.KTY: b"kty"}, "kty(1) should be int or str(tstr)."),
            ({COSEKeyParams.KTY: {}}, "kty(1) should be int or str(tstr)."),
            ({COSEKeyParams.KTY: []}, "kty(1) should be int or str(tstr)."),
            ({COSEKeyParams.KTY: 7}, "Unsupported or unknown kty(1): 7."),
            ({COSEKeyParams.KTY: COSEKeyTypes.ASYMMETRIC, COSEKeyParams.ALG: b"alg"}, "alg(3) should be int or str(tstr)."),
            ({COSEKeyParams.KTY: COSEKeyTypes.ASYMMETRIC, COSEKeyParams.ALG: {}}, "alg(3) should be int or str(tstr)."),
            ({COSEKeyParams.KTY: COSEKeyTypes.ASYMMETRIC, COSEKeyParams.ALG: []}, "alg(3) should be int or str(tstr)."),
            ({COSEKeyParams.KTY: COSEKeyTypes.ASYMMETRIC, COSEKeyParams.ALG: 0}, "Unsupported or unknown alg(3): 0."),
        ],
    )
    ...
    def test_cose_key_interface(self):
        ki = COSEKeyInterface({COSEKeyParams.KTY: COSEKeyTypes.ASYMMETRIC, COSEKeyParams.ALG: COSEAlgs.A128GCM})
